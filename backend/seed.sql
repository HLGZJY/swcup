...
-- 3. 创建动物档案 (10只: 7狗3猫，覆盖不同状态)
INSERT INTO animals (animal_id, status, species, breed, color, gender, age_estimate, health_status, sterilized, first_seen_at, last_seen_at, location_lat, location_lng, address, notes, tags, photos, created_at, updated_at) VALUES

-- 狗: 走失
('a-00001-0001-0001-000000000001', 'lost',    'dog', '金毛',     '金色',   'male',   'adult',  'healthy', true,  '2026-05-08 08:00:00', '2026-05-10 10:00:00', 31.2304, 121.4737, '上海市静安区南京西路1788号',     '走失时佩戴蓝色项圈，尾巴尖有白毛，很亲人',          '[\"走失\", \"佩戴项圈\", \"亲人\"]',    '[]', '2026-05-08 08:00:00', '2026-05-10 10:00:00'),
('a-00002-0002-0002-000000000002', 'lost',    'dog', '土狗',     '棕色',   'female', 'adult',  'healthy', false, '2026-05-10 09:00:00', '2026-05-11 11:00:00', 31.2404, 121.4837, '上海市静安区北京西路100号',      '左耳有缺口，很温顺，旁边有狗粮',                    '[\"走失\", \"温顺\"]',              '[]', '2026-05-10 09:00:00', '2026-05-11 11:00:00'),
('a-00003-0003-0003-000000000003', 'lost',    'dog', '萨摩耶',   '白色',   'male',   'adult',  'healthy', true,  '2026-05-11 10:00:00', '2026-05-12 12:00:00', 31.2504, 121.4937, '上海市静安区华山路88号',         '走失时穿红色背心，很干净，毛发洁白',                 '[\"走失\", \"穿背心\"]',            '[]', '2026-05-11 10:00:00', '2026-05-12 12:00:00'),
('a-00004-0004-0004-000000000004', 'lost',    'dog', '拉布拉多', '黄色',   'male',   'adult',  'injured', true,  '2026-05-12 08:00:00', '2026-05-13 09:00:00', 31.2604, 121.5037, '上海市浦东新区世纪大道200号',    '右后腿受伤，行走缓慢，急需救助',                     '[\"走失\", \"受伤\", \"急需救助\"]',  '[]', '2026-05-12 08:00:00', '2026-05-13 09:00:00'),
('a-00005-0005-0005-000000000005', 'lost',    'dog', '柴犬',     '黑色',   'female', 'adult',  'healthy', false, '2026-05-09 08:00:00', '2026-05-10 18:00:00', 31.2104, 121.4637, '上海市徐汇区淮海中路999号',     '棕色围脖，很警觉，不让人靠近',                       '[\"走失\", \"警觉\"]',              '[]', '2026-05-09 08:00:00', '2026-05-10 18:00:00'),
('a-00006-0006-0006-000000000006', 'lost',    'dog', '哈士奇',   '灰白',   'male',   'adult',  'healthy', true,  '2026-05-12 14:00:00', '2026-05-13 16:00:00', 31.2804, 121.5237, '上海市浦东新区张江镇碧波路',    '蓝色眼睛，胖胖的，很亲人，在路边找水喝',             '[\"走失\", \"亲人\"]',              '[]', '2026-05-12 14:00:00', '2026-05-13 16:00:00'),
('a-00007-0007-0007-000000000007', 'lost',    'dog', '泰迪',     '棕色',   'female', 'adult',  'healthy', false, '2026-05-11 10:00:00', '2026-05-12 15:00:00', 31.2304, 121.4837, '上海市静安区陕西北路100号',    '剪了造型，很干净，疑似走失',                         '[\"走失\"]',                      '[]', '2026-05-11 10:00:00', '2026-05-12 15:00:00'),

-- 狗: 已找到/已认领
('a-00008-0008-0008-000000000008', 'claimed', 'dog', '边牧',     '黑白',   'female', 'adult',  'healthy', true,  '2026-05-03 10:00:00', '2026-05-05 14:00:00', 31.2204, 121.4537, '上海市长宁区延安西路100号',    '被人捡到，已联系主人认领',                           '[\"捡到\", \"已认领\"]',            '[]', '2026-05-03 10:00:00', '2026-05-05 14:00:00'),
('a-00009-0009-0009-000000000009', 'found',   'dog', '柯基',     '黄白',   'male',   'puppy',  'healthy', false, '2026-05-07 09:00:00', '2026-05-08 11:00:00', 31.2704, 121.5137, '上海市闵行区莘庄镇莘建路88号',  '走失小狗，在路边徘徊，疑似与主人走散',               '[\"捡到\", \"待认领\"]',            '[]', '2026-05-07 09:00:00', '2026-05-08 11:00:00'),

-- 猫
('a-00010-0010-0010-000000000010', 'lost',    'cat', '中华田园猫','橘色',  'male',   'adult',  'healthy', false, '2026-05-06 10:00:00', '2026-05-08 16:00:00', 31.2304, 121.4637, '上海市静安区新闸路200号',      '橘色狸花，胖胖的，佩戴粉色项圈',                     '[\"走失\", \"佩戴项圈\"]',          '[]', '2026-05-06 10:00:00', '2026-05-08 16:00:00'),
('a-00011-0011-0011-000000000011', 'lost',    'cat', '英短',     '蓝灰色', 'female', 'adult',  'ill',     true,  '2026-05-10 09:00:00', '2026-05-11 14:00:00', 31.2404, 121.4737, '上海市静安区昌平路50号',       '眼睛有分泌物，精神不佳，疑似生病',                   '[\"走失\", \"生病\"]',              '[]', '2026-05-10 09:00:00', '2026-05-11 14:00:00'),
('a-00012-0012-0012-000000000012', 'found',   'cat', '波斯猫',   '白色',   'male',   'senior', 'healthy', true,  '2026-05-05 10:00:00', '2026-05-07 13:00:00', 31.2504, 121.4837, '上海市静安区江宁路88号',        '纯白波斯猫，很温顺，在长椅上晒太阳',                 '[\"捡到\", \"待找主人\"]',          '[]', '2026-05-05 10:00:00', '2026-05-07 13:00:00');
