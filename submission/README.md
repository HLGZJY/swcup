...
| [02-架构设计.md](02-架构设计.md) | 10-15 页：5 层架构 + 模块 + 时序图（含评论 AI 中台 + intent 派生） | ⭐⭐⭐ |
| [03-接口设计文档.md](03-接口设计文档.md) | 15-25 页：47 REST + 4 AI 端点 | ⭐⭐⭐ |
| [04-数据库设计文档.md](04-数据库设计文档.md) | 8-12 页：6 张表 ER + DDL | ⭐⭐ |
...
| **2. 工程完整度** | 25% | 03-接口设计文档（47 端点）<br>04-数据库设计文档（6 表 ER + DDL）<br>code/（完整可编译） |
